            ...
            <div class="flex h-screen overflow-y-hidden bg-white" x-data="setup()"
                ...
                <aside x-transition:enter="transition transform duration-300"
                    ...
                    <nav class="flex-1 overflow-hidden hover:overflow-y-auto">
                                ...
                                <a href="{{ route('dashboard.category.index') }}"
                                    ...
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24"
                                            width="24" height="24">
                                            <path
                                                d="M20.457,4.555,12.486.126a1,1,0,0,0-.972,0L3.543,4.555A3,3,0,0,0,2,7.177V19a5.006,5.006,0,0,0,5,5H17a5.006,5.006,0,0,0,5-5V7.177A3,3,0,0,0,20.457,4.555ZM20,19a3,3,0,0,1-3,3H7a3,3,0,0,1-3-3V7.177A1,1,0,0,1,4.515,6.3L12,2.144,19.486,6.3A1,1,0,0,1,20,7.177Z"
                                                fill="#3b4e5d" data-original="#000000" />
                                            <circle cx="12" cy="7" r="1.5" /></svg>
                                    </span>
                                    <span :class="{ 'lg:hidden': !isSidebarOpen }"> {{ __('Category Produk') }}</span>
                                </a>
                            </li>
                            <!-- Sidebar Links... -->
                        </ul>
                        ...
                        <ul class="p-2 overflow-hidden">
                            <li>
                                <a href="{{ route('dashboard.transaction.index') }}"
                                    ...
                                    <span :class="{ 'lg:hidden': !isSidebarOpen }"> {{ __('Transaksi') }}</span>
                                </a>
                            </li>
                            <!-- Sidebar Links... -->
                        </ul>
                                    ...
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                                            ...
                                            <path
                                                ...
                                                fill="#3b4e5d" data-original="#000000" /></svg>
                                    </span>
                                    <span :class="{ 'lg:hidden': !isSidebarOpen }"> {{ __('Mitra Vendor') }}</span>
                                </a>
                            </li>
                            <!-- Sidebar Links... -->
                        </ul>
                        <ul class="p-2 overflow-hidden">
                            <li>
                                <a href="{{ route('dashboard.calonvendor.index') }}"
                                    class="flex items-center p-2 space-x-2 rounded-md hover:bg-gray-100"
                                    :class="{'justify-center': !isSidebarOpen}">
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1"
                                    ...
                                    <span :class="{ 'lg:hidden': !isSidebarOpen }"> {{ __('Calon Vendor') }}</span>
                                </a>
                            </li>
                            <!-- Sidebar Links... -->
                        </ul>
                                    ...
                                    <span>
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24"
                                            ...
                                            <g id="_01_align_center" data-name="01 align center">
                                                ...
                                                <polygon
                                                    points="21 10 21 7 19 7 19 10 16 10 16 12 19 12 19 15 21 15 21 12 24 12 24 10 21 10" />
                                                <path
                                                    d="M13.043,14H4.957A4.963,4.963,0,0,0,0,18.957V24H2V18.957A2.96,2.96,0,0,1,4.957,16h8.086A2.96,2.96,0,0,1,16,18.957V24h2V18.957A4.963,4.963,0,0,0,13.043,14Z" />
                                            </g>
                                        </svg>
                                    </span>
                                    <span :class="{ 'lg:hidden': !isSidebarOpen }"> {{ __('User Wesp') }}</span>
                                </a>
                            </li>
                            <!-- Sidebar Links... -->
                        </ul>
                ...
                <div class="flex flex-col flex-1 h-full overflow-hidd">
                    <!-- Navbar -->
