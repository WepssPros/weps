...
<!-- Main content header -->
                        <div
                                    ...
                                    <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                                        {{ __('Dashboard - Admin - GalleryProduk' )   }}
                        ...
                        <div class="py-1">
                            <div class="flex-col items-start justify-between pb-6 space-y-4 border-b lg:items-center lg:space-y-0 lg:flex-row">
                                <div class="mb-10 pt-2">
                                    ...
                                    <a href="{{ route('dashboard.product.index') }}" class="bg-green-500 hover:bg-green-700 ml-3 text-white font-bold py-2 px-4 rounded shadow-lg">
                                        << Kembali
                                    </a>
                                </div>
