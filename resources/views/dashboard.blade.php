...
<div class="grid grid-cols-1 gap-6 mt-4 md:grid-cols-2">
    <div class="p-4 items-center justify-center bg-white rounded-md shadow-md">
        <table id="example" class="hidden" style="width: 100%">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Position</th>
    ...
    <div class="p-4 items-center justify-center bg-white rounded-md shadow-md">
        <table id="example-2" class="hidden" style="width: 100%">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Position</th>
...
<div class="grid grid-cols-1 gap-6 mt-4 md:grid-cols-2">
    <div class="p-4 items-center justify-center bg-white rounded-md shadow-md">
        <table id="example-3" class="hidden" style="width: 100%">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Position</th>
    ...
    <div class="p-4 items-center justify-center bg-white rounded-md shadow-md">
        <table id="example-4" class="hidden" style="width: 100%">
            <thead>
                <tr>
                    <th>Name</th>
                    <th>Position</th>
...
<script>
    $(document).ready(function () {
        ...
        // On each draw, update the data in the chart
        table.on("draw", function () {
            chart.series[0].setData(chartData3(table));
        });
    });
